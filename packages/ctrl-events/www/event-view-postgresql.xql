...
<queryset>
  <rdbms><type>postgresql</type><version>7.4</version></rdbms>
	...
	<fullquery name="get_repeat_event_data">
		<querytext>
			select ctrl_events.event_id, ctrl_events.title, acs_object__name(object_id) as object, 
			...
			where ctrl_events.event_object_id = acs_objects.object_id and ctrl_events.repeat_template_p = 'f' 
				...
				and (to_char(ctrl_events.start_date, 'YYYY/MM/DD') > to_char(current_timestamp, 'YYYY/MM/DD')) 
