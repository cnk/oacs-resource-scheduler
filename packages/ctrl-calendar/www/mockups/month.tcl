...
if {$cal_id} {
    ...
    set page_title "$subsite_name Monthly View"
...
set object_event_info [ctrl::cal::event::get_list -cal_id_list $object_id_list -viewtype "month" -current_julian_date $julian_date]
