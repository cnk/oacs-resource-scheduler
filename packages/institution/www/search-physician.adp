...
<script language="javascript1.2"><!--
	function doSearchOnLetter(ltr) {
		with(document.search_physician) {
			// reset to defaults
...
//--></script>
<formtemplate id="search_physician">
<p>
...
<br><a href="search-physician"><ul><li>Click here to perform a New Search</ul></a>
	...
	<else>
		...
		<table align="center" border="0" cellpadding="2" cellspacing="2">
			...
			<tr><td colspan="100%">
				<include	src="search-physician-iterators"
							rowcount="@rowcount@"
							position="@startrow@"
							maxrows="@maxrows@"></td>
			</tr>
			...
			<multiple name="found">
				<if @found.result_in_range_p@>
					...
					<td align="center">
						<if @found.photo_p@>
							<div style="padding-left: 5px; padding-right: 5px"><img height="35" src="photo?personnel_id=@found.physician_id@"></div></if>
...
<script language="JavaScript1.2"><!--
	...
	with(document.forms.search_physician) {
		for(i = 0; i < elements.length; i++) {
