# -*- tab-width: 4 -*-
# /packages/party-image/www/index.tcl
ad_page_contract {
	This is the main page for the party_images part of the institution package.

	@param			party_id	(optional) the party_id of the party_images you wish to view, defaults to [ad_conn user_id]
...
set context		[list "Party Images"]
set obj_type_pl	"Party Images"
...
# require 'create' on current party to create party_images:
if {$create_p} {
	set party_image_create_url	"add-edit?[export_vars {party_id}]"
} else {
	set party_image_create_url	""
}

# items is an sql-query (be careful) or comma-delimited list of values
set items					[db_map party_images]
