# -*- tab-width: 4 -*-
# /packages/certification/www/index.tcl
ad_page_contract {
	This is the main page for the certifications part of the institution package.

	@param			party_id	(optional) the party_id of the certifications you wish to view, defaults to [ad_conn user_id]
...
set context		[list "Certifications"]
set obj_type_pl	"Certifications"
...
# require 'create' on current party to create certifications:
if {$create_p} {
	set certification_create_url	"add-edit?[export_vars {party_id}]"
} else {
	set certification_create_url	""
}

# items is an sql-query (be careful) or comma-delimited list of values
set items					[db_map certifications_of_party]
