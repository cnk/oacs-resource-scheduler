...
For each website, you can choose a set of titles to show and an order to show
them in.
</p>

<p> <h3 style="color: maroon; display: inline">Choose the website</h3> that you wish
	to arrange titles for:
		...
		<blockquote>
			<multiple name="personnel_subsite_list">
				<a href="@personnel_subsite_list.select_subsite_url@">
					@personnel_subsite_list.subsite_name@</a>
				<if @this_subsite_id@ eq @personnel_subsite_list.chosen_subsite_id@>
				...
				<if @personnel_subsite_list.n_arranged_for_subsite@ gt 0>
					<small><b>
						<a	href="@personnel_subsite_list.reset_arrangement_url@"
							title="Click to reset this arrangement of @personnel_subsite_list.n_arranged_for_subsite@ titles to the default"
							><font color="red">
								( reset
