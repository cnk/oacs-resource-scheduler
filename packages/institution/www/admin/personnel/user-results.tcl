# /packages/institution/personnel/user-results.tcl

ad_page_contract {

    Display User returned from sql_query

    @author nick@ucla.edu
    @creation-date 2004/03/24
    @cvs-id $Id: user-results.tcl,v 1.1.1.1 2006/09/13 01:29:59 nsadmin Exp $
} {
} 
...
#ad_return_complaint 1 $personnel_search_p
#return
