		...
		with(document.search) {
			...
			for(i = 0; i < elements.length; i++) {
				if(elements[i].name == 'display'			||	// dont reset the display order
					...
					elements[i].name == 'exclude_group_id'	||	// dont reset this
...
<if @n_results_on_page@ defined>
	...
	<table class="layout" width="100%">
		...
		<span class="main-text">
			<b>Find a person by choosing from the following search options.</b>
		</span>
		</td></tr>
	...
	<table align="center">
		...
		<if 0><tr>
			...
			Research Interest:</td><td>
			<formwidget id="research_interest"/><br>
