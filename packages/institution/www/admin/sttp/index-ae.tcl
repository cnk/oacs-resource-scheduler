...
ad_page_contract {
    ...
    {order_by:optional}
    {order_dir:optional}
    {personnel_id:integer   {[ad_conn user_id]}}
}
...
set sttp_add "../personnel/index"
set sttp_delete "sttp-delete?[export_vars personnel_id]"
set sttp_edit "sttp-mentor-ae?[export_vars personnel_id]&user_id=$personnel_id"
