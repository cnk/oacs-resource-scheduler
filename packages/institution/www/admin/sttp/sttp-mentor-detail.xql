...
<queryset>
        <fullquery name="sttp_selection">
                <querytext>
                        select  i.description, i.n_grads_currently_employed,
                                ...
                                i.department_chair_name, i.personnel_id,
				p.last_name, p.first_names, pa.url
                        from    inst_short_term_trnng_progs i, persons p, parties pa
                        where   i.personnel_id = p.person_id and
        ...
        <fullquery name="sttp_division">
                <querytext>
			select 	g.group_id, g.short_name
			from	inst_short_term_trnng_progs i, inst_groups g
