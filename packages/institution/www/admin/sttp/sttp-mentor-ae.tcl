...
ad_page_contract {
	...
	@cvs-id			$Id: sttp-mentor-ae.tcl,v 1.1.1.1 2006/09/13 01:29:59 nsadmin Exp $
...
#	set expiration_date			[split $expiration_date "-"]
	...
	if {[exists_and_not_null error_p]} {
		ad_return_complaint 1 "<p>Could not edit STTP Mentorship.</p><pre>$errmsg</pre>"
		ad_script_abort
	}
} -after_submit {
