# -*- tab-width: 4 -*-
# /packages/address/www/index.tcl
ad_page_contract {
	This is the main page for the addresses part of the institution package.

	@param			party_id	(optional) the party_id of the addresses you wish to view, defaults to [ad_conn user_id]
...
set context		[list "Addresses"]
set obj_type_pl	"Addresses"
...
# require 'create' on current party to create addresses:
if {$create_p} {
	set address_create_url	"add-edit?[export_vars {party_id}]"
} else {
	set address_create_url	""
}

# items is an sql-query (be careful) or comma-delimited list of values
set items					[db_map addresses_of_party]
