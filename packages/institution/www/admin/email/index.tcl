# -*- tab-width: 4 -*-
# /packages/email/www/index.tcl
ad_page_contract {
	This is the main page for the emails part of the institution package.

	@param			party_id	(optional) the party_id of the emails you wish to view, defaults to [ad_conn user_id]
...
set context		[list "Email Addresses"]
set obj_type_pl	"Email Addresses"
...
# require 'create' on current party to create emails:
if {$create_p} {
	set email_create_url	"add-edit?[export_vars {party_id}]"
} else {
	set email_create_url	""
}

# items is an sql-query (be careful) or comma-delimited list of values
set items					[db_map emails_of_party]
