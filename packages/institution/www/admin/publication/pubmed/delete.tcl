# /packages/institution/www/admin/publication/pubmed/delete.tcl

ad_page_contract {

    Page for deleting pubmed XML data for a publication
...
publication::pubmed::delete -publication_id $publication_id -single_pubmed_id $pubmed_id
