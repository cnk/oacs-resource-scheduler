# -*- tab-width: 4 -*-
# /packages/institution/www/phone-number/index.tcl
ad_page_contract {
	This is the main page for the phone-numbers part of the institution package.

	@param			party_id	(optional) the party_id of the owner of the phone-numbers you wish to view, defaults to [ad_conn user_id]
...
set context		[list "Phone Numbers"]
set obj_type_pl	"Phone Numbers"
...
# require 'create' on current party to create phone-numbers:
if {$create_p} {
	set phone_create_url	"add-edit?[export_vars {party_id}]"
} else {
	set phone_create_url	""
}

# items is an sql-query (be careful) or comma-delimited list of values
set items					[db_map phones_of_party]
