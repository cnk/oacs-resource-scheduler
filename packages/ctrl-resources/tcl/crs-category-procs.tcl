...
namespace eval crs::ctrl {}
namespace eval crs::ctrl::category {}

ad_proc -public crs::ctrl::category::create_root {
} {
    Creates the Root Node of the category tree
} {
    return [ctrl::category::new -parent_category_id "" \
		-name "CTRL Resource" \
		-plural "CTRL Resource" \
		-description "CTRL Resource Categories" \
		-enabled_p t \
		-profiling_weight 1 \
		-context_id [ad_conn package_id]]
}

ad_proc -public crs::ctrl::category::create_for_package { 
    {-package_id:required}
} {
    Creates a category tree for package
    @param package_id the package id
} {
    set parent_category_id [ctrl::category::find -path [list "CTRL Resource"]]
    ...
    return [crs::ctrl::category::new -name package_$package_id -package_id $package_id -context_id $package_id]
}

ad_proc -public crs::ctrl::category::root_info { 
    {-info id}
    {-package_id ""}
} {
    ...
    set path "CTRL Resource//package_$package_id"
    if {[string equal $info path]} {
	return $path
    }
    return [ctrl::category::find -path [list "CTRL Resource" "package_$package_id"]]
}

ad_proc -public crs::ctrl::category::new {
    {-parent_category_id	""}
    {-name:required}
    {-plural				""}
    {-description			""}
	...
	set parent_category_id [crs::ctrl::category::root_info -info id -package_id $package_id]
    }
...
ad_proc -public crs::ctrl::category::option_list {
    {-path:required}
    {-package_id ""}
    {-top_label}
    {-top_value}
    ...
    set root_path [crs::ctrl::category::root_info -info path -package_id $package_id]
...
ad_proc -public crs::ctrl::category::find {
    {-path:required}
    {-package_id ""}
} {
