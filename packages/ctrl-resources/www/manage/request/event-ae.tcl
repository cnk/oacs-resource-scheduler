# /packages/ctrl-resources/www/event-ae.tcl

ad_page_contract {

    Add/Edit Event
    This can be associated with the request or not
...
if {[exists_and_not_null event_id]} {
    set submit_btn "Edit Event"
} else {
    set submit_btn "Add Event"
}
