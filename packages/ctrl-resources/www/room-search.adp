...
<table>
   <tr><td>Room Name (ie: Ackerman)</td> <td><formwidget id="name"> </td></tr>
   <tr> <td>Minimum capacity:</td> <td><formwidget id="capacity"> </td></tr>
   <tr>  <td>Location:</td> <td><formwidget id="location"> </td></tr>
   ...
   <tr>  <td>Additional Services:</td> <td><formwidget id="add_services"> </td></tr>
