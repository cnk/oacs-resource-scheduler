  ...
  <rdbms><type>oracle</type><version>8.1.6</version></rdbms>
	...
	<fullquery name="get_juilian_date">
		<querytext>
			...
			from    ctrl_events ce
                	where   ce.event_object_id = :room_id
...
as sunday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday'),'yyyy mm dd hh24')
as sunday_date,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 1,'J')
as monday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 1,'yyyy mm dd hh24')
as monday_date,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 2,'J') 
as tuesday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 2,'yyyy mm dd hh24') 
as tuesday_date,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 3,'J') 
as wednesday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 3,'yyyy mm dd hh24') 
as wednesday_date,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 4,'J') 
as thursday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 4,'yyyy mm dd hh24') 
as thursday_date,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 5,'J')
as friday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 5,'yyyy mm dd hh24')
as friday_date,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 6,'J') 
as saturday_j,
to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - 7, 'Sunday') + 6,'yyyy mm dd hh24') 
as saturday_date
from     dual
</querytext>
</fullquery>
