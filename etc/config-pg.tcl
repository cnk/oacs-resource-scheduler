...
set server                    "kaos" 
set servername                "OpenACS 5.4 - Room Reservations Development - Postgres"
...
ns_param   serverlog          ${logdir}/${server}-pg-error.log 
...
ns_section ns/server/${server}/module/nslog 
    ...
    ns_param   file               ${logdir}/${server}-pg.log
...
if { $database eq "oracle" } {
    ns_param   ora            ${bindir}/nsoracle.so
} else {
